...
public class TiposUsuariosController implements Serializable {
    ...
    private List<TiposUsuarios> items_eliminados = null;

    public List<TiposUsuarios> getItems_eliminados() {
    ...
    public void setItems_eliminados(List<TiposUsuarios> items_eliminados) {

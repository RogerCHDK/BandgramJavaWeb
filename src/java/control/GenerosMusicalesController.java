...
public class GenerosMusicalesController implements Serializable {
    ...
    private List<GenerosMusicales> items_eliminados = null;

    public List<GenerosMusicales> getItems_eliminados() {
    ...
    public void setItems_eliminados(List<GenerosMusicales> items_eliminados) {
